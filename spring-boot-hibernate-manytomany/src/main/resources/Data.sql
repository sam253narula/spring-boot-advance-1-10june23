...
values(1,'Spring Boot JPA', CURRENT_DATE(), CURRENT_DATE());
insert into course(id, name, created_date, last_updated_date) 
values(2,'Spring Boot AWS Utilites', CURRENT_DATE(), CURRENT_DATE());
insert into course(id, name, created_date, last_updated_date) 
values(3,'Spring Boot GCP GKE Cloud Deployment', CURRENT_DATE(), CURRENT_DATE());
